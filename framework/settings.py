...
TEMPLATES = [
    {
        ...
        "DIRS": [str(FRAMEWORK_DIR / "templates")],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
DATABASES = {
    "default": {
        ...
        "NAME": BASE_DIR / os.getenv("DATABASE_NAME", "quiz.sqlite3"),
    }
}
...
STATIC_ROOT = FRAMEWORK_DIR / "staticfiles"

STATIC_URL = "/static/"

STATICFILES_DIRS = [FRAMEWORK_DIR / "static"]
